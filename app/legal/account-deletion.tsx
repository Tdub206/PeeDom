...
export default function AccountDeletionScreen() {
    ...
    try {
      ...
      showToast({
        ...
        message:
          ...
          'Your StallPass account and synced user data have been removed from this device and backend.',
  ...
  const handleDeleteAccount = useCallback(async () => {
    ...
    Alert.alert(
      ...
      'This removes your StallPass account, favorites, reports, ratings, claims, and uploaded photo metadata. Bathrooms you added can remain on the map anonymously.',
      [
        {
          text: 'Cancel',
          style: 'cancel',
        ...
        <ScrollView keyboardShouldPersistTaps="handled" contentInsetAdjustmentBehavior="automatic" className="flex-1">
          <View className="px-6 py-8">
            <View className="rounded-[32px] bg-danger px-6 py-8">
              ...
              <Text className="mt-3 text-4xl font-black tracking-tight text-white">Delete your StallPass account.</Text>
            ...
            {!user ? (
              <View className="mt-6 rounded-[32px] border border-surface-strong bg-surface-card p-6">
                ...
                <Text className="mt-3 text-base leading-7 text-ink-700">
                  You must be authenticated to delete the current StallPass account. If you are viewing this page on the web, sign in there or from the mobile app and return to this screen.
                </Text>
