      ...
      <ScrollView className="flex-1" contentInsetAdjustmentBehavior="automatic">
        <View className="px-6 py-8">
          <View className="rounded-[32px] bg-ink-900 px-6 py-8">
            ...
            <Text className="mt-3 text-4xl font-black tracking-tight text-white">How Pee-Dom handles your data.</Text>
            <Text className="mt-3 text-base leading-6 text-white/80">
              This policy describes the data processed by the Pee-Dom mobile app and its connected Supabase backend.
            </Text>
          </View>
          ...
          <View className="mt-6 rounded-[32px] border border-surface-strong bg-surface-card p-6">
            ...
            <Text className="mt-3 text-base leading-7 text-ink-700">
              If you delete your account, Pee-Dom removes the account and cascades deletion across user-owned records. Bathrooms you personally submitted can remain on the community map, but their authorship is cleared so they are no longer tied to your identity.
            </Text>
            <Text className="mt-3 text-base leading-7 text-ink-700">
