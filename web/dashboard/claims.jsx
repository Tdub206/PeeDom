  ...
  return (
    <div className="sp-page">
      <SectionHead
        ...
        sub="See the status of each claim. Approved claims show up in your Locations page."
        action={
          <Btn variant="primary" onClick={() => setShowForm(true)}>
            <IcoPlus size={14} /> New claim
          </Btn>
        }
      />
      ...
      <div style={{ display: 'flex', gap: 16, marginBottom: 24, flexWrap: 'wrap' }}>
        {[
          ['approved', 'Approved - listing is live'],
          ['pending', 'Under review - usually 1-3 days'],
          ...
          <tbody>
            {claims.map((claim) => (
              <tr key={claim.id}>
                ...
                <td>
                  <Badge tone={STATUS_TONE[claim.status]} size="lg">
      ...
      {claims.some((c) => c.status === 'pending') && (
        <div
          style={{
            ...
            border: '1px solid rgba(164,99,18,0.15)',
            borderRadius: 14,
            display: 'flex',
            gap: 12,
        ...
        >
          ...
          <div style={{ fontSize: '0.86rem', color: 'var(--ink-soft)', lineHeight: 1.6 }}>
            <strong style={{ color: 'var(--ink)' }}>You have a claim under review.</strong> Our team usually reviews
            submissions within 1-3 business days. You will get an email after a decision is made.
          </div>
        </div>
      )}
...
function NewClaimModal({ onClose, onSave }) {
  ...
  return (
    ...
    >
      ...
      >
        After you submit this, our team will review your ownership details. Most claims are reviewed within 1-3
        business days.
      </div>
      <div style={{ display: 'grid', gap: 14 }}>
        ...
        <div className="sp-field">
          ...
          <span style={{ fontSize: '0.76rem', color: 'var(--ink-muted)' }}>
            You can find this in a Google Maps link. It helps us match your listing faster.
          </span>
        </div>
        <div className="sp-field">
          ...
          <textarea
            ...
            placeholder="For example: business license URL, utility bill, or manager approval letter"
          />
        </div>
      </div>
    </Modal>
