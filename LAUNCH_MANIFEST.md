...
1. Supabase migrations `058_restroom_intelligence_layer.sql`, `059_entitlement_idempotency_and_restroom_rls.sql`, `060_business_restroom_metadata_analytics.sql`, `061_saved_need_profile_default_rpc.sql`, and `062_rewarded_unlock_verification_polling.sql` define the restroom-intelligence, entitlement idempotency, business metadata, analytics, and AdMob reward verification polling contracts.
