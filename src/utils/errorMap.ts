...
const DATABASE_CODE_MESSAGE_MAP: Record<string, string> = {
  ...
  INSUFFICIENT_UNLOCK_POINTS: 'You need more contribution points for this one-time unlock.',
  INVALID_REDEMPTION_PERIOD: 'Choose a valid premium redemption period.',
  INVALID_UNLOCK_METHOD: 'That unlock option is not available right now.',
  ...
  STARTER_UNLOCK_ALREADY_USED: 'Your free unlock has already been used on this account.',
